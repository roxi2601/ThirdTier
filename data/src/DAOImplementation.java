...
public class DAOImplementation {
	private DatabaseHelper<UserDTO> helper;

	public DAOImplementation(DatabaseHelper<UserDTO> helper) {
		this.helper = helper;
	}
	...
	public UserDTO create(int id, String username, String password, int securityLevel, String firstName, String lastName,
		...
		return new UserDTO(id, username, password, securityLevel, firstName,lastName,description,img);
	}
